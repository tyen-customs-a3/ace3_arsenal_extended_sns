class XtdGearModels {
    class CfgWeapons {
        ...
        class sns_nw_u_bdu {
            ...
            class camo {
                values[] = {"M81", "DCU-3", "DCU-6", "ERDL-L", "OD", "T/MOUT"};
                class M81 { label = "M81"; };
                class DCU_3 { label = "DCU (3-Color)"; };
                class DCU_6 { label = "DCU (6-Color)"; };
                class ERDL_L { label = "ERDL"; };
                class OD { label = "OD"; };
        ...
        class sns_nw_u_civ {
            ...
            class shirt { values[] = {"White", "Red", "Red-Light", "Blue", "Blue-Dark", "Khaki", "Green", "VTN Khaki", "VTN Jean"}; };
        ...
        class sns_nw_v_pasgt {
            ...
            class camo {
                values[] = {"M81", "DCU", "Green", "ERDL", "T/MOUT"};
            };
            class webbing {
                values[] = {"None", "ALICE", "LBV"};
            };
            class loadout {
                values[] = {"Rifleman", "Grenadier", "SAW", "Sidearm", "Medic", "Light"};
            };
        };
        ...
        class sns_nw_v_alice {
            ...
            class loadout { values[] = {"Rifleman", "Rifleman (Alt)", "Light", "Grenadier", "Sidearm", "MG", "M56"}; };
            class attachments { values[] = {"None", "E-Tool"}; };
        };

        class sns_nw_v_flak_webbing {
            label = "Flak Vest w/ Webbing";
            options[] = {"flak_model", "webbing", "loadout"};
            class flak_model {
                label = "Flak";
                values[] = {"M1955"};
            };
            class webbing { values[] = {"ALICE LC-1", "ALICE LC-2"}; };
            class loadout { values[] = {"Rifleman", "Grenadier", "Sidearm", "MG"}; };
        };
        ...
        class sns_nw_v_lbv88 {
            ...
            class loadout { values[] = {"Rifleman", "Sidearm"}; };
        };
        ...
        class sns_nw_v_rba {
            ...
            class loadout { values[] = {"Rifleman", "Grenadier", "SAW", "Sidearm"}; };
        };
        ...
        class sns_nw_v_aws {
            ...
            class loadout { values[] = {"Rifleman", "Light"}; };
        };
        ...
        class sns_nw_v_fauf {
            ...
            options[] = {"belt", "loadout"};
            class belt { values[] = {"None", "ALICE"}; };
            class loadout { values[] = {"Rifleman", "Sidearm", "SAW"}; };
        };
        ...
        class sns_nw_h_pasgt {
            ...
            class cover {
                values[] = {"M81", "DCU", "Desert", "Green", "T/MOUT"};
            };
            class scrim {
        ...
        class sns_nw_h_protec {
            ...
            class headset { values[] = {"None", "Standard"}; };
